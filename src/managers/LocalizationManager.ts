...
export class LocalizationManager {
    ...
    private translations: Record<Language, Record<string, string>> = {
        en: {
            ...
            howto_step4: 'Hammer clears a 3×3 area. New shapes replaces the figures below the field',
        ...
        ru: {
            ...
            howto_step4: 'Молоток очищает область 3×3. Новые фигуры заменяет фигуры под полем',
        ...
        uz: {
            ...
            howto_step4: "Bolg'a 3×3 maydonni tozalaydi. Yangi shakllar pastdagi figuralarni almashtiradi",
